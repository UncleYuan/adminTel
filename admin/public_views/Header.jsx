...
var Header=React.createClass({
  ...
  toggleSider:function(){
    PubSub&&PubSub.publish('toggleSider');
  },
  loginOut:function(){
    $.ajax({
        url: '/auth.do',
    ...
    <div className="header-section">
        ...
        <div className="menu-right">
            <ul className="notification-menu">
               ...
               <DropdownMenu title="设置"  small="true" btnText={<div><img src={this.state.userInfo.avatar} alt="" />欢迎您，{this.state.userInfo.username}<span className="caret"></span></div>}>
                  <ul className="dropdown-list normal-list">
                        <li>
                            <a  href="javascript:;" onClick={this.loginOut}><i className="md md-fullscreen"></i>退出登录</a>
                        </li>
                        <li>
